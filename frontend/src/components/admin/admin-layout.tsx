      ...
      `}>
            ...
            return (
              <div key={item.href}>
                <Link
                  href={item.href}
                  onClick={() => setIsMobileMenuOpen(false)}
                  className={`flex items-center justify-between px-6 py-3 text-sm font-medium transition relative ${active
                ...
                >
                  ...
                  {item.badge && (
                    <span className={`px-2 py-0.5 text-xs font-semibold rounded-full ${item.badgeColor || 'bg-green-600'
                      } text-white`}>
                      {item.badge}
                    </span>
                  )}
        ...
        <div className="border-t border-gray-200 p-4">
          ...
          <Link
            href="/admin/docs"
            onClick={() => setIsMobileMenuOpen(false)}
            className={`w-full flex items-center gap-2 px-4 py-2 mb-1 text-sm rounded-lg transition ${pathname === '/admin/docs'
