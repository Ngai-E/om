...
const SETTING_LABELS: Record<string, { label: string; description: string; placeholder?: string }> = {
  ...
  platform_subdomain_suffix: { label: 'Subdomain Suffix', description: 'Appended to tenant slugs for storefront URLs (e.g. slug.viralsocialmediabooster.com)', placeholder: 'viralsocialmediabooster.com' },
            ...
            <div className="p-6 border-b">
              ...
              <p className="text-sm text-gray-500 mt-1">
                ...
                <code className="bg-gray-100 px-1.5 py-0.5 rounded text-xs font-mono">
                  {'{slug}'}.{getValue('platform_subdomain_suffix') || 'viralsocialmediabooster.com'}
                </code>
              </p>
            </div>
